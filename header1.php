...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <a class="navbar-brand" href="html/home.html">MADHUBAN</a>
  <ul class="navbar-nav">
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" href="html/about2.html">ABOUT US</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="html/contact.html">CONTACT US</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="html/bookingpage.php">BOOK TABLE</a>
    </li>
  </ul>
</nav>
